 ...
 * interface includes methods for an additional set of system bindings.  These
 * system bindings are intended to by used by services to support their needs
 * to store objects persistently.  The objects associated with system bindings
 ...
 * for system bindings by using their class or package name as the prefix for
 * the name.
 */
public interface DataService extends DataManager, Service {

    /**
     * Obtains the object associated with the system binding of a name.
     ...
     * @return	the object associated with the system binding of the name
     ...
     */
    <T extends ManagedObject> T getSystemBinding(String name, Class<T> type);

    /**
     * Specifies an object for the system binding of a name, replacing any
     ...
     *
     * @param	name the name
     * @param	object the object associated with the system binding of the
     *		name
     ...
     *		problem with the current transaction
     */
    void setSystemBinding(String name, ManagedObject object);

    /**
     * Removes the system binding for a name.  Note that the object previously
