 ...
 * @version 1.0
 */
public class TransitionTimerTestBoot
        implements SimBoot<TransitionTimerTestBoot>, Task
{
        ...
        if (tickCount == 2) {
            periodicTaskHandle =
                    AppContext.getTaskManager().schedulePeriodicTask(
                        this, 1000, 500);
            System.out.println("Scheduled periodic task, handle = " +
                    periodicTaskHandle);
        } else if (tickCount == 10) {
            System.out.println("Cancelling periodic task, handle = " +
                    periodicTaskHandle);
