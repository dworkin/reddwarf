...
/**
 * 
 * <p>Title: IChannelRoomListener</p>
 * 
 * <p>Description: Super interface for listeners on a channel room.</p>
 * 
 ...
 * @version 1.0
 */
public interface IChannelRoomListener {
	
    /**
     * Called when a player enters the channel room.  This call back is fired once
     * for each user as they join the room.  It is also fired once for each player
     * already connected to the channel room when a player first joins to receive the 
     ...
     */
    public void playerBootedFromGame(byte[] booter, byte[] bootee, boolean isBanned);
