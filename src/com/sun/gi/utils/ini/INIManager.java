...
public class INIManager {
    Map<String, Map<String, String>> paragraphs =
        new HashMap<String, Map<String, String>>();

    public INIManager(File iniFile) {
        Map<String, String> currentParagraph = null;
        try {
            ...
            if (line.charAt(0) == '[') { // new paragraph
                ...
                currentParagraph = new HashMap<String, String>();
    ...
    public INIParagraph getParagraph(String paragraph) {
        Map<String, String> p = paragraphs.get(paragraph);
        if (p == null) {
            return null;
        }
