...
public class StatisticalUUID implements SGSUUID {
    ...
    public int ioByteSize() {
        // when writing or reading in this value we use 8 bytes
        return 16;
    }
