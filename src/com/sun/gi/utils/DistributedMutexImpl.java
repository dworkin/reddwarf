...
public class DistributedMutexImpl implements DistributedMutex, Comparable {
    ...
    public DistributedMutexImpl(String idstring, DistributedMutexMgrImpl manager) {
        id = idstring;
        mgr = manager;
    }
    ...
    public void resetTimeout(long t) {
