...
public interface NIOSocketManagerListener {
    ...
    /**
     * Notify this listener that a new incoming connection has been
    ...
    /**
     * Notify this listener that the connection attempt was successful.
     * 
     ...
     * 
     * @param connection the NIOConnection object that has failed to
     * connect
     */
