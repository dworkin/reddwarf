...
/**
 * Defines the primary class necessary to implement the server side of
 * an SGS UserManager. A user manager is responsible for creating a
 * SGSUser for each legitimately logged in user and reigstering it with
 * the Router. It is strongly recommended that implementors use the
 * provided SGSUserImpl class for their SGSUsers.
 * 
...
public interface UserManager {
    ...
    /**
     * Provides the name of a class that a client should instantiate in
     * order to connect to this SGS Server UserManager. That class
     * implements the UserManagerClient interface.
     * 
