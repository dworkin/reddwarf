...
/**
 * An extension of SGSUserImpl which adds a queue and a batchprocessor
 * to the user The queue is used to hold any messages that need to be
 * sent to the user, the batchprocessor is used to process multiple
 * packets
 * 
 * @author as93050
 */
