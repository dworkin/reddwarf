...
/**
 * UserManagerPolicy defines a pluggable component used to
 * decide which instance of a UserManager to connect to.
 *
...
public interface UserManagerPolicy {
     ...
     * a game and all available conenction points to that game's SGS
     * server.
     * 
     * @param umanagerName the fully-qualified class name of the
     * UserManager we have chosen for our connection. A user manager
