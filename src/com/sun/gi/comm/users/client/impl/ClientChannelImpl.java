...
public class ClientChannelImpl implements ClientChannel {
     ...
     * Constructor
     *
     * @param manager The ClientConnectionManager that created this channel
     *		      object
     *
     * @param channelName the name of the channel this object represents
     *
     * @param channelID the Darkstar backend's id for our view of this channel.
     * This ID is local to this connection and is not gauranteed to be the same
     * for otehr users on the same channel.
     */
