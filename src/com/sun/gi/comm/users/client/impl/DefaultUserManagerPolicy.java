...
/**
 * <p>
 * Title: DefaultUserManagerPolicy
 * </p>
 * <p>
 * Description: This class implements a simple stochastic choice of
...
public class DefaultUserManagerPolicy implements UserManagerPolicy {
     ...
     * a game including details on all available connection points.
     * 
     * @param umanagerName The FQCN of the desired userManager.
     * 
     * @return a DiscoveredUserManager structure describing the chosen
     * user manager, or null if there are no valid candidates.
     */
