...
/**
 * ClientChannel defines a SGS channel for use by a client program.
 * 
...
public interface ClientChannel {
    ...
    /**
     * Sets the one-and-only listener for events on this channel. Only
     * one listener is allowed per channel
     * 
    ...
    /**
     * Closes the channel for this user. Everyone else sees this as a
