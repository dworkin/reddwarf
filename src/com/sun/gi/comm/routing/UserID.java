...
/**
 * An opaque type that represents a user connection to the router
 * system. A "user" of the router system may be a game client conecting
 * through a UserManager or might be a backend server such as a game
 * logic engine that exists in the same process space as the Router
 * itself.
 * 
