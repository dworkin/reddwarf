...
public class USERMANAGER extends com.borland.xml.toolkit.XmlObject 
{
	...
	/** Defines a clientclass attribute */
	public com.borland.xml.toolkit.Attribute clientclass = new com.borland.xml.toolkit.Attribute("clientclass", "NMTOKEN", "REQUIRED", "");
	...
	/**
	 * Gets the value of "clientclass" attribute.
	 */
	public String getClientclass()
	{
		return clientclass.getValue();
	}
	 ...
	 */
	public void setClientclass(String value_)
	{
		clientclass.setValue(value_ );
	}
	...
	public com.borland.xml.toolkit.Element marshal()
	{
		...
		/** Marshals "clientclass" attribute */
		elem.addAttribute(clientclass.marshal());
	...
	public static USERMANAGER unmarshal(com.borland.xml.toolkit.Element elem)
	{
		...
		{
			/** Unmarshals "clientclass" attribute */
			__objUSERMANAGER.clientclass.setValue(elem.getAttribute("clientclass"));
		}
	...
	public com.borland.xml.toolkit.ErrorList validate(boolean firstError)
	{
		...
		if( _objPARAMETER.size() == 0 )
		{
			errors.add(new com.borland.xml.toolkit.ElementError(this, PARAMETER.class));
			if( firstError )
				return errors;
		}
		else
		...
		/** LOGINMODULE is one or more */
		if( _objLOGINMODULE.size() == 0 )
		{
			errors.add(new com.borland.xml.toolkit.ElementError(this, LOGINMODULE.class));
			if( firstError )
				return errors;
		}
		else
