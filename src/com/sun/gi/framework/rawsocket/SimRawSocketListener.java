...
/**
 * Objects interested in communicating with sockets to arbitrary hosts
...
public interface SimRawSocketListener {
     ...
     * given ID. The data in the buffer is ready to be read (i.e. has
     * already been flipped if necessary).
     * 
     * @param socketID the ID of the socket.
     ...
     * one of the other socket operations. Since the I/O is
     * non-blocking, requested operations happen asynchronously. This
     * callback serves as a "catch all" error message that some
     * requested operation failed. The IOException will contain the
     * details.
     * 
