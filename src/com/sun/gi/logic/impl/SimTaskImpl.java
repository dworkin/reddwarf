...
public class SimTaskImpl extends SimTask {
	...
	private List<UIDListenerRec> userDataListenerQueue = new ArrayList<UIDListenerRec>();

	private List<CIDListenerRec> channelListenerQueue = new ArrayList<CIDListenerRec>();

	private List<CIDListenerRec> channelMembershipListenerQueue = new ArrayList<CIDListenerRec>();
	...
	public GLOReference createGLO(GLO simObject, String name) {
		long objid = trans.create(simObject, name);
	 ...
	 * 
	 * @param simObject
	 *            the GLO to insert into the objects store
	 * 
