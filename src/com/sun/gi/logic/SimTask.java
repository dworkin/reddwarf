...
public abstract class SimTask {
    ...
    /**
     * A utility call used by other parts of the system. It takes a Game
     * Logic Object (GLO) ID and wraps it in a GLOReference.
     * 
     * @param id the GLO id
     * 
    ...
    /**
     * Gets the transaction associated with this SimTask. A SimTask only
     * has a transaction associated with it during execution.
     * 
    ...
    /**
     * Registers a GLO as a listener to user join/left events. The
     * listening GLO must implement the SimUserListener interface.
     * 
    ...
    /**
     * Registers a GLO as a listener to data packet arrival events. It
     * listens for data adressed to the UserID passed.
     * 
     ...
     * channel. This actually maps to the sendMulticast call down in the
     * router layer by calling the user manager created to handle this
     * particular game.
     * 
     * @param cid the channel ID
     ...
     * store, if a GLO does not already exist with the given name. This
     * object should *not* be used after being passed to the createGLO
     * call -- instead, call get() on the returned GLOReference to get
     ...
     * 
     * @param simObject the "template object" to insert into the object
     * store. This object should *not* be used after being passed to the
     ...
     * symbolic name assigned to the GLO at the time of creation in the
     * objectstore.
     * 
     ...
     * channel is already open, return a valid ChannelID for the
     * existing channel. Note that channels may be referred to by more
     * than one channelID.
     * 
     * @param channelName the name of the channel to create
     * 
     * @return a new ChannelID for the channel created. ChannelIDs are
     * not unique -- a channel may be referred to by more than one
     * channelID.
     */
     ...
     * 
     * @throws ExecutionOutsideOfTaskException if called outside of the
     * context of an SGS task dispatch.
     */
