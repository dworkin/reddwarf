 ...
 * <p>Title: GLO</p>
 * 
 * <p>Description: All GLOs (Game Logic Objects) should implement this
 * interface.  GLOs are the basic unit of a game's presence on the SGS.  The
 * only constraint on a GLO is that it be Serializable to facilitate storage on
 * the back-end.
 *
