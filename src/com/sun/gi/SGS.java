...
public class SGS {
	...
	try {
	    ...
	    /*
	     * XXX: For single-stack case, use a non-multicast, no-op
	     *      transport at the router layer.  This is both faster
	     *      and works around the lack of message-fragmentation
	     *      in LRMP (which limits message sizes to UDP-max)
	     *
	     *      To use the LRMP routing, use:
	     *        routerTransportManager = transportManager;
	     *      -jm
	     */
