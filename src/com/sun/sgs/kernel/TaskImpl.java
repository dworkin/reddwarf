...
public class TaskImpl implements Task {
    ...
    /**
     * The priority of this task relative to the
     * <code>AppContext</code> and <code>User</code> associated with
     * the task.
     */
    private final Priority priority;

    /**
     * The quality of service paramaters that affect how this tasks is
     * run
     */
    private final Quality quality;

    /**
     * The user on whose behalf this Task is run
     */
     ...
     */
    public TaskImpl(Runnable runnable, AppContext appContext, Quality quality, Priority priority, User user) {
    ...
    // NOTE: comments found in Task.java
    public User getUser() {
	return user;
    }
