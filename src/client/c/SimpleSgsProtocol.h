 ...
 *
 * This file is a C-port of com.sun.sgs.protocol.simple.SimpleSgsProtocol
 */
...
#ifndef _SIMPLESGSPROTOCOL_H
#define _SIMPLESGSPROTOCOL_H

/**
 * The maximum length of any protocol message field defined as a
 * String or byte[]: 65535 bytes
 */
#define SGS_MAX_MESSAGE_LENGTH 65535

/* The maximum length of the optional data part of a message. */
#define SGS_MAX_MSG_DATA_LENGTH 65528   /* this is just SGS_MAX_MESSAGE_LENGTH minus 7 for the other fields */

/* The version number */
#define SGS_VERSION 1

/* Whether to use/expect compact-IDs (or "verbose" IDs) */
#define SGS_COMPACT_IDS 1
...
#define SGS_ServiceId enum SGS_ServiceId
...
enum SGS_OpCode {
   ...
   * </ul>
   */
  SGS_SESSION_MESSAGE = 0x30,

  /**
   * Logout request.
   */
  SGS_LOGOUT_REQUEST = 0x40,

  /**
   * Logout success (logout request acknowledgment).
   */
  SGS_LOGOUT_SUCCESS = 0x41,
   ...
   * </ul>
   */
  SGS_CHANNEL_MESSAGE = 0x54,
};

#define SGS_OpCode enum SGS_OpCode
