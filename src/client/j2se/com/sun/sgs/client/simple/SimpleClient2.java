...
public class SimpleClient2 implements ServerSession {
        ...
        implements ClientConnectionListener
    {
        ...
        /**
         * All Protocol level messages will come in on this call-back from
        ...
        public void receivedMessage(byte[] message) {
            ...
            if (versionNumber != ProtocolMessage.VERSION) {
                ...
                // don't
                // match. Probably need to disconnect the client with an
                // error.
            ...
            // "Application
            // Service" -- the only other service besides the "Channel
            // Service".
