...
import com.sun.sgs.test.impl.service.data.TestConcurrent;
import java.util.Properties;

public class TestDataServiceConcurrentClient extends TestConcurrent {
    ...
    public TestDataServiceConcurrentClient(String name) {
	super(name);
    }
