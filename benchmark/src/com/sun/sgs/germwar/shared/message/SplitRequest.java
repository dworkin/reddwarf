 ...
 * location to another.
 */
public class SplitRequest implements AppMessage {
    private int bacteriumId;
    private Coordinate src, dest;

    /**
     * Creates a new {@code SplitRequest}.
     */
    public SplitRequest(int bacteriumId, Coordinate src, Coordinate dest) {
    ...
    /**
     * Creates a new {@code SplitRequest} by reading fields out of {@code buf}.
     */
    public static SplitRequest fromBytes(ByteBuffer buf) {
        ...
        return new SplitRequest(bacteriumId, src, dest);
    }
