...
messages. The Python client's SmokeTestClient.py file can be used as a guideline for
implementing a test client. A flowchart in PDF format is included for easier
...
1. Login with the "kickme" username -> Assert the loginFailed callback is correctly hit.
2. Login again with any other username
...
---------------------------------
- Implement multi-node smoke test (reconnection, etc...).
