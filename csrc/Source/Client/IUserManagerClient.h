...
public:
	...
	virtual bool Connect(IDiscoveredUserManagerPtr userManager, IUserManagerClientListenerPtr listener) = 0;

	virtual void Login() = 0;
	virtual void ValidationDataResponse(const std::vector<ICallbackPtr>& callbacks) = 0;
