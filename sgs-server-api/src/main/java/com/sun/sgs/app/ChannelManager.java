 ...
 * the most efficient means (e.g., protocol and transport) to satisfy the
 ...
 * stronger delivery guarantees.  A client session can not be joined to a
 * channel if that client session does not support a protocol satisfying
 * the minimum requirements of the channel's delivery guarantee.
 *
