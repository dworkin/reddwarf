...
// if either buffer sizes is set to 0, a default value will be used (currently 64K).
...
(
	...
	const GT2Byte * message,  // the message to send, or NULL for an empty message
...
(
	...
	unsigned long ip,          // the remote ip, in network byte order
