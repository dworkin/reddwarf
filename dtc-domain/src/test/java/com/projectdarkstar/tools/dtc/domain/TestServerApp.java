...
/**
 * Test ServerApp entity
 */
@Ignore
public class TestServerApp extends BaseEntityJunit4Fixture<ServerApp>
{
    public TestServerApp() {
        super(ServerApp.class, new Generator[]{/*new ConfigGenerator(),*/ new PkgLibraryGenerator()});
    }

    @GeneratorType(className = List.class, field="configs")
    private static final class ConfigGenerator extends BeanCollectionGenerator<ServerAppConfig> {
        private ConfigGenerator() {
            super(ServerAppConfig.class, 10);
        }
    }
