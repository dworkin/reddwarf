...
/*
 * LrmpException.java - LrmpException.
 * Author:  Tie Liao (Tie.Liao@inria.fr).
 * Created: 27 December 1996.
 * Updated: no.
 */
package inria.net.lrmp;

/**
 * Lrmp exception that is raised when an error occurs in calling
 * an Lrmp method.
 */
public class LrmpException extends Exception {

    /**
     * constructs an instance of LrmpException with the specified detail message. A detail
     * message is an instance of String that describes this particular exception.
     * @param msg the detail message.
     */
    public LrmpException(String msg) {
        super(msg);
    }
