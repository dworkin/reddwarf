 ...
 * {@link ProfileConsumer#createSample(String, ProfileConsumer.ProfileDataType,
 * int, ProfileCollector.ProfileLevel) createSample}.  A sample's name
 * includes both the {@code name} supplied to {@code createSample} and
