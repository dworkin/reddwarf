...
/**
 * Self sorting affinity group implementation.
 * <p>
 * This object implements {@link Comparable} and when placed in an sorted
 * collection these objects will be sorted based on the number of identities
 * in the group.
 */
class AffinityGroupImpl implements AffinityGroup, Comparable {
    ...
    long findTargetNode(NodeMappingServerImpl server) {
        ...
        System.out.println("group: " + agid +
                           " found target node to be " + targetNodeId +
                           " with " + leadingCount +
                           " of " + identities.size() + " members");
    ...
    public int compareTo(Object obj) {
        ...
        return identities.size() <
                            ((AffinityGroupImpl)obj).identities.size() ? -1 : 1;
    }
    ...
    GroupInfo getGroupInfo() {
        return new GroupInfoImpl(agid, targetNodeId, getIdentities());
    }
