...
/**
 * Affinity group finder stats for the distributed label propagation
 * algorithm.
 */
public class LPFinderStats extends AffinityGroupFinderStats {
     ...
     */
    public LPFinderStats(ProfileCollector collector, int stopIter) {
