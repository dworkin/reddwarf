 ...
 */
public final class AsyncSSLServerSocketChannelImpl
    extends AsynchronousServerSocketChannel
{
     ...
     */
    @Override
    public AsyncSSLServerSocketChannelImpl bind(SocketAddress local,
                                             int backlog)
        throws IOException
    {
     ...
     */
    @Override
    public AsyncSSLServerSocketChannelImpl setOption(SocketOption name,
                                                  Object value)
        throws IOException
    {
