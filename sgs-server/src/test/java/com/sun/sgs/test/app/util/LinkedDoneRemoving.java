 ...
 */
class LinkedDoneRemoving implements Runnable {

    /** The ScalableHashMap.noteDoneRemoving field. */
    private static Field noteDoneRemoving =
	getField(ScalableLinkedHashMap.class, "noteDoneRemoving");
    ...
    private static final LinkedDoneRemoving INSTANCE = new LinkedDoneRemoving();
    ...
    /**
     * A task that notifies the LinkedDoneRemoving class that the task that finished
