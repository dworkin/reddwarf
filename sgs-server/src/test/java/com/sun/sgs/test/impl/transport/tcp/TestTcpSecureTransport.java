...
import com.sun.sgs.impl.transport.tcp.TcpSecureTransport;
...
public class TestTcpSecureTransport {
    ...
    public void testNullProperties() throws Exception {
        transport = new TcpSecureTransport(null);
    }

    @Test
    public void testDefaults() throws Exception {
        transport = new TcpSecureTransport(new Properties());
    ...
    public void testAcceptConnect() throws Exception {
        ...
        client.connect(TcpSecureTransport.SECURE_PORT);
        if (!handler.isConnected()) {
            throw new Exception("Server did not receive connect");
        }

        final DummyClient clientB = new DummyClient("testAcceptConnectB");
        clientB.connect(TcpSecureTransport.DEFAULT_PORT);
        if (!handler.isConnected()) {
            throw new Exception("Server did not receive 2nd connect");
        }
        shutdown();
    }
    ...
    public void testServerDisconnect() throws Exception {
        ...
        final DummyClient clientB = new DummyClient("testServerDisconnectB");
        clientB.connect(TcpSecureTransport.DEFAULT_PORT);
    ...
    public void testClientDisconnect() throws Exception {
        ...
        final DummyClient clientB = new DummyClient("testClientDisconnect");
        clientB.connect(TcpSecureTransport.DEFAULT_PORT);
